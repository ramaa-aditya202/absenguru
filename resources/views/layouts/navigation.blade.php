<nav x-data="{ open: false }" class="bg-white dark:bg-gray-800 border-b border-gray-100 dark:border-gray-700">
            ...
            <div class="hidden sm:flex sm:items-center sm:ms-6">
                ...
                <div class="hidden sm:flex sm:items-center sm:ms-6">
                    <x-dropdown align="right" width="48">
                        ...
                        <x-slot name="content">
                            <x-dropdown-link :href="route('piket.teachers.index')">
                                {{ __('Lihat Guru') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('piket.subjects.index')">
                                {{ __('Lihat Mata Pelajaran') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('piket.classrooms.index')">
                                {{ __('Lihat Kelas') }}
                            </x-dropdown-link>
                            <x-dropdown-link :href="route('piket.schedules.index')">
                                {{ __('Lihat Jadwal') }}
                            </x-dropdown-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        ...
        @elseif(Auth::user()->role == 'piket')
            <div class="pt-4 pb-1 border-t border-gray-200 dark:border-gray-600">
                <div class="px-4">
                    <div class="font-medium text-base text-gray-800 dark:text-gray-200">Data Sekolah</div>
                </div>
                <div class="mt-3 space-y-1">
                    <x-responsive-nav-link :href="route('piket.teachers.index')">
                        {{ __('Lihat Guru') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('piket.subjects.index')">
                        {{ __('Lihat Mata Pelajaran') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('piket.classrooms.index')">
                        {{ __('Lihat Kelas') }}
                    </x-responsive-nav-link>
                    <x-responsive-nav-link :href="route('piket.schedules.index')">
                        {{ __('Lihat Jadwal') }}
                    </x-responsive-nav-link>
