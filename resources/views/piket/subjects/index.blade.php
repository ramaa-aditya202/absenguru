{{-- resources/views/piket/subjects/index.blade.php --}}
<x-app-layout>
    <x-slot name="header">
                        ...
                        <div class="flex">
                            ...
                            <div class="ml-3">
                                <p class="text-sm text-blue-700">
                                    <strong>Mode Piket:</strong> Anda dapat melihat data mata pelajaran namun tidak dapat menambah, mengedit, atau menghapus data.
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full bg-white border">
                            ...
                            <tbody>
                                ...
                                @empty
                                    <tr>
                                        <td colspan="4" class="py-4 px-4 border-b text-center text-gray-500">Tidak ada data mata pelajaran.</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
